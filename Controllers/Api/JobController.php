    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($students->isNotEmpty()) {
                // Send Email individually to each student (More compatible with SMTP limits)
                ...
                // Add Internal System Notifications (Visible in UI)
                foreach ($students as $student) {
                    Notification::create([
                        'user_id' => $student->id,
                        'type' => 'new_vacancy',
            ...
            \Log::error('Failed to send job vacancy notifications: ' . $e->getMessage());
        }
