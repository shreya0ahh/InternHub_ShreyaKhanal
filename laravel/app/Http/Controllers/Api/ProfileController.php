...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $user->update($request->only([
            'name', 'headline', 'bio', 'location', 'industry', 'website', 'github', 'portfolio', 'company_size', 'skills', 'experience', 'education', 'projects'
        ]));

        // Calculate profile completion (simplified)
        $fields = ['avatar', 'headline', 'bio', 'location', 'skills', 'experience', 'education', 'projects', 'github', 'portfolio'];
